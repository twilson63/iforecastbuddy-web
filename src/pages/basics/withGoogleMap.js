  ...
  return (_temp2 = _class = (function(_Component) {
    ...
    function Container() {
      ...
      return (_ret = (
        ...
        (_this.handleComponentMount = _this.handleComponentMount.bind(_this)),
        _temp
    ...
    return Container
  })(_react.Component)), (_class.displayName =
    'withGoogleMap(' +
    (0, _reactDisplayName2.default)(WrappedComponent) +
    ')'), (_class.propTypes = {
    containerElement: _propTypes2.default.node.isRequired,
    mapElement: _propTypes2.default.node.isRequired
  }), (_class.childContextTypes = (0, _defineProperty3.default)(
    {},
    _constants.MAP,
